          ...
          <div className="grid lg:grid-cols-5 gap-10 items-center">
            <div className="lg:col-span-3">
              ...
              <div className="mt-4 text-neutral-content flex flex-col gap-2 text-sm md:text-base">
                <p>
                  Marketing has undergone a significant transformation. People
                  now spend a considerable amount of time on the internet rather
                  than engaging with traditional mediums like TV.
                </p>
                <p>
                  As a result, marketing medium is also changed. It has become
                  essential for businesses to promote themselves online rather
                  than relying solely on TV commercials, print ads, billboards,
                  and other traditional methods.
                </p>

                <p>
                  At our agency, we offer a complete digital marketing solution
                  for businesses across various industries. We are proud to be
                  recognized as the Best Digital Marketing Agency in Dhaka.
                </p>
              </div>
            ...
            <div className="lg:col-span-2 ">
              <img
                src="/images/service_details/digital-marketing/digital-marketing.png"
                alt=""
